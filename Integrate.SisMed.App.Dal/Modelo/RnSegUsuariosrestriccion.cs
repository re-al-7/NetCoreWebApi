	...
	public class RnSegUsuariosrestriccion
	{
		...
		public EntSegUsuariosrestriccion ObtenerObjeto(int intidsur)
		{
			...
			using (HttpClient client = new HttpClient())
			{
				...
				HttpResponseMessage response = client.GetAsync(CParametros.StrApiTables + EntSegUsuariosrestriccion.StrNombreTabla + "/" + intidsur).Result;
		...
		public List<EntSegUsuariosrestriccion> ObtenerLista()
		{
			...
			using (HttpClient client = new HttpClient())
			{
				...
				HttpResponseMessage response = client.GetAsync(CParametros.StrApiTables + EntSegUsuariosrestriccion.StrNombreTabla).Result;
				if (response.StatusCode == HttpStatusCode.OK)
				{
					var stringData = response.Content.ReadAsStringAsync().Result;
		...
		public bool Delete(EntSegUsuariosrestriccion obj, bool bValidar = true)
		{
			...
			using (HttpClient client = new HttpClient())
			{
				...
				HttpResponseMessage response = client.DeleteAsync(CParametros.StrApiTables+ EntSegUsuariosrestriccion.StrNombreTabla +"/" + obj.idsur).Result;
				if (response.StatusCode == HttpStatusCode.OK)
				{
					var strResult = response.Content.ReadAsStringAsync().Result;
					bProcede = true;
